  ...
  switch (role) {
    case "ADMIN":
      return [
        ...
        { href: "/portal/admin/leases", label: "Leases & Billing", icon: "home" },
        { href: "/portal/admin/documents", label: "Documents", icon: "file" },
        ...
        { href: "/portal/staff/messages", label: "Messages", icon: "message" },
    ...
    case "STAFF":
      return [
        ...
        { href: "/portal/staff/applications", label: "Applications", icon: "clipboard" },
        { href: "/portal/staff/residents", label: "Residents", icon: "home" },
        { href: "/portal/staff/documents", label: "Documents", icon: "file" },
        { href: "/portal/staff/maintenance", label: "Maintenance", icon: "wrench" },
        { href: "/portal/staff/messages", label: "Messages", icon: "message" },
        { href: "/portal/staff/announcements", label: "Announcements", icon: "megaphone" },
        { href: "/portal/notifications", label: "Notifications", icon: "bell" },
